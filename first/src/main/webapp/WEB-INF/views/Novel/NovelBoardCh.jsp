...
<head>
  ...
  <script type="text/javascript" language="javascript">  
  	...
  	function novelWrite(){
  		...
  		console.log(LoginID);
  		if(LoginID != null){
  			let novel_title = $('input[name=novel_title]').val();
	...
	<div class="container-fluid text-center">    
	  <div class="row content">
	    <div class="col-sm-2 sidenav">
	     <%--  <%@ include file="../Module/NovelProfile.jsp"%> --%>
	     <jsp:include page="../Module/NovelProfile.jsp"></jsp:include>
	    </div>
	    <div class="col-sm-8 MainContainer"> 
	    	<h1>${title}</h1>
	    	<input type="hidden" name="NBT" value="${title}">
	    	<input type="hidden" name="NBI" value="${sessionScope.LoginID}">
